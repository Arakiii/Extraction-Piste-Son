...
void TrackView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (TrackView::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TrackView::requestAddEvent)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (TrackView::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TrackView::requestDeleteEvent)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject TrackView::staticMetaObject = {
    { &QTableView::staticMetaObject, qt_meta_stringdata_TrackView.data,
