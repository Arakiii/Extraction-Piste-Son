...
const QMetaObject TrackModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_TrackModel.data,
      qt_meta_data_TrackModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TrackModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TrackModel.stringdata0))
        return static_cast<void*>(const_cast< TrackModel*>(this));
